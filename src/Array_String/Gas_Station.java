/*
    ...
    Therefore, you can't travel around the circuits at once no matter where you start.
...
public int canCompleteCircuit(int[] gas, int[] cost) {
    int n = gas.length;
    for (int i = 0; i < n; i++) { // iterate through the array of gas and cost
        int totalFuel = 0;
        int stopCount = 0;
        int j = i;
        // keep track of the total fuel and the number of stops
        while (stopCount < n) {
...
void main() {
    //Example 1:
    int[] ex1Gas = {1,2,3,4,5};
    int[] ex1Cost = {3,4,5,1,2};
    int ex1Expected = 3;
    int ex1Actual = canCompleteCircuit(ex1Gas, ex1Cost);
